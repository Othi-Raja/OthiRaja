      ...
      <Row className='top_form'>
        <Col md={{ span: 6, offset: 3 }}>
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group controlId="formName" data-aos="fade-in"data-aos-easing="ease-in-back"data-aos-delay="600"data-aos-offset="0">
              <Form.Label>Name:</Form.Label>
              <Form.Control type="text" placeholder="Enter your name" required className='input' />
            </Form.Group>

            <Form.Group controlId="formEmail"  data-aos="fade-zoom-in"data-aos-easing="ease-in-back"data-aos-delay="600"data-aos-offset="0">
              <Form.Label>Email:</Form.Label>
              <Form.Control type="email" placeholder="Enter your email" required className='input' />
            </Form.Group>

            <Form.Group controlId="formMessage"  data-aos="fade-zoom-in"data-aos-easing="ease-in-back"data-aos-delay="600"data-aos-offset="0">
