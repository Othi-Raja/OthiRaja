          ...
          >
            <div className="FE_card codezila" onClick={url.Amjathkhan}>
              {loader ? (
                ...
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/image-f2f77.appspot.com/o/am.png?alt=media&token=e0e66a05-6bc3-4b3d-aa7e-06377910de97"
                  className="FE_card-img1 img-fluid"
                  alt="intern-project"
                />
              )}
              <span className="FE_title">Amjathkhan</span>
            </div>
          </Col>
          <Col
            lg={4}
          ...
          >
            <div className="FE_card instaclone" onClick={url.instagram_cloned}>
              {loader ? (
                ...
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/image-f2f77.appspot.com/o/instaimg.png?alt=media&token=9150044b-3b9e-4bfa-a95f-06c1055dc387"
                  className="FE_card-img2 img-fluid"
                  alt="intern-project"
                />
              )}
              <span className="FE_title">Instagram-clone</span>
            </div>
          </Col>
          <Col
            lg={4}
          ...
          >
            <div className="FE_card" onClick={url.mrchef}>
              {loader ? (
                ...
                <img
                  className="FE_card-img3 img-fluid"
                  src="https://firebasestorage.googleapis.com/v0/b/image-f2f77.appspot.com/o/mrcheif.png?alt=media&token=013c2c3f-f5f0-4d64-b475-492fdfa5cd93"
                  alt="Mr chef"
                />
              )}
              <span className="FE_title">Mr.Chef</span>
            </div>
          </Col>
          <Col className="ViewMore">
            <button
              type="button"
              className="btn ViewMoreBtn float-end"
            ...
            <div className="modal-body modal-bg">
              <Container>
                ...
                <Row style={{ width: '100%', marginTop: '10px' }}>
                  ...
                  <Row className='pt-4'>
                    <h3 className='work-title '>Intern@<a href='https://www.linkedin.com/company/urbanriderapp/about/' target='_blank' rel="noreferrer">UrbanRider </a><svg data-tooltip-id="my-tooltip-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-info-circle mx-2" viewBox="0 0 16 16">
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                      <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0" />
                    </svg></h3>
                    <ReactTooltip
